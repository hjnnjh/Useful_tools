...
# Form implementation generated from reading ui file 'Translator_GUI_v6.ui'
#
...
class Ui_Translator_Google(object):
    def setupUi(self, Translator_Google):
        ...
        Translator_Google.resize(763, 595)
        ...
        self.gridLayout.addWidget(self.translate_2_button, 1, 1, 1, 2)
