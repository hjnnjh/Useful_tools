...
# Form implementation generated from reading ui file 'Translator_GUI_v10.ui'
#
...
class Ui_Translator_Google(object):
    def setupUi(self, Translator_Google):
        ...
        Translator_Google.resize(778, 547)
        ...
        self.gridLayout.addWidget(self.add_content_button, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.clear_content_button, 1, 5, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setStyleSheet("font: 14pt \"微软雅黑\";")
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 2, 0, 1, 1)
        self.add_content_button_2 = QtWidgets.QPushButton(self.centralwidget)
        self.add_content_button_2.setStyleSheet("font: 14pt \"微软雅黑\";")
        self.add_content_button_2.setObjectName("add_content_button_2")
        self.gridLayout.addWidget(self.add_content_button_2, 2, 1, 1, 1)
        ...
        self.clear_content_button_2 = QtWidgets.QPushButton(self.centralwidget)
        self.clear_content_button_2.setStyleSheet("font: 14pt \"微软雅黑\";")
        self.clear_content_button_2.setObjectName("clear_content_button_2")
        self.gridLayout.addWidget(self.clear_content_button_2, 2, 5, 1, 1)
        ...
        self.add_content_button_2.clicked.connect(partial(self.get_text_youdao, mode="add_text"))
        self.clear_content_button_2.clicked.connect(self.clear_content)
        self.add_new_paragragh_button_2.clicked.connect(partial(self.get_text_youdao, mode="add_ph"))
    ...
    def get_text_youdao(self, mode):
        """
        Youdao engine deal text
        :return:
        """
        global text, content_counter, result
        if mode == "add_text":
    ...
    def retranslateUi(self, Translator_Google):
        ...
        self.add_content_button_2.setText(_translate("Translator_Google", "增加文本内容"))
        self.add_new_paragragh_button_2.setText(_translate("Translator_Google", "增加新的段落"))
        self.translate_2_button_2.setText(_translate("Translator_Google", "翻译"))
        self.clear_content_button_2.setText(_translate("Translator_Google", "清除内容"))
